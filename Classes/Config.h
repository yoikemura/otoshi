...
static struct CHARA CHARA_DATA[] = {
    ...
    },
    {
        ...
        "ロボゴマ",
        "goma_robot.png",
        "世田谷に住む独身博士(64)が寂しさを紛らわすために作った人造ゴマフアザラシ。3時間充電で32時間ほど稼働する。博士曰く「iPhoneより長持ち」",
        10
    },
    {
        "0007",
    ...
    },
    {
        ...
        "メロンモンキー",
        "melonmonkey.png",
        "メロンでメロゥなモンキーGUY!! フルーツ界の神であ、音楽の王様でもある彼は、ゴマフアザラシ界のジャスティン・ビーバー。カーネギーメロン大学卒。",
        10
    },
    {
        "0010",
    ...
    },
    {
        ...
        "民衆を導く自由のゴマビィ",
        "goma_free.png",
        "ついに現れた。彼こそが今回の事件の首謀者であり、カリスマ、民衆を導きく自由のゴマビィだ！憧れはメタナイト。",
        1
    }
};
